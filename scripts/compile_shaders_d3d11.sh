...
TARGET="windows" # directory its saved in
FSPROFILE="fs_5_0"  # profile (see comment code below for possibilities)
VSPROFILE="vs_5_0"  # profile (see comment code below for possibilities)
###
