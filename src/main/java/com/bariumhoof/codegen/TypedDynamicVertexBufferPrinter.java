...
public class TypedDynamicVertexBufferPrinter {
    ...
    private static final String expansion2 = "T\\* extends BgfxAttribType, V\\* extends Vec<N\\*, T\\*>";
    ...
    public static void main(String[] args) {
        ...
        for (int i=1; i < upperBound; i++) {
            ...
            for (int j=1; j <= i; j++) {
                ...
                expansion3_n.append(String.format("T%d[] t%d", j, j));
            }
            ...
            for (int j=1; j <= i; j++) {
                ...
                expansion4_n.append(String.format("t%d", j));
            }
...
//            "}\n";
    ...
    public static final String classesTemplate =
            ...
            "        }\n" +
            "\n" +
            "        public void update(int startVertex, @NotNull T*[] t*) {\n" +
    ...
    public static final String tail =
            ...
            "    private static int computeStrideBytes(BgfxAttribType[][] arrays) {\n" +
            "        int total = 0;\n" +
            "        for (BgfxAttribType[] array : arrays) {\n" +
            "            final BgfxAttribType sample = array[0];\n" +
            "            final BGFX_ATTRIB_TYPE type = sample.representedType();\n" +
