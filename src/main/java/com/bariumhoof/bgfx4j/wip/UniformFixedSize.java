...
//public class UniformFixedSize implements Handle, Disposable {
//
...
//
//    private UniformFixedSize(String name, BGFX_UNIFORM_TYPE type, int numElementsInArray, short handle) {
//        this.name = name;
//        this.type = type;
...
//    }
//
//    public static UniformFixedSize create(@NotNull String name, @NotNull BGFX_UNIFORM_TYPE type, int numElementsInArray) {
//        final short handle = bgfx_create_uniform(name, type.VALUE, numElementsInArray);
//        return new UniformFixedSize(name, type, numElementsInArray, handle);
//    }
//
