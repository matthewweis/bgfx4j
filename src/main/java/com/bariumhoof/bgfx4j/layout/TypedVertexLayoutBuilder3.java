...
public class TypedVertexLayoutBuilder3<E1 extends BgfxAttrib, V1 extends Vec<?,?>, E2 extends BgfxAttrib, V2 extends Vec<?,?>> {
    private final VertexLayoutStructBuilder2<E1, V1, E2, V2> last;

    TypedVertexLayoutBuilder3(VertexLayoutStructBuilder2<E1, V1, E2, V2> last) {
        this.last = last;
    }
    ...
    public class AttribTypeStageDefaultOpts<E extends BgfxAttrib, V extends Vec<?,?>> {
        ...
        final VertexLayoutStructBuilder3<E1, V1, E2, V2, E, V> newLast() {
            return new VertexLayoutStructBuilder3<>(last, attrib, vec, normalized, asInt);
        }

        public final VertexLayoutStruct<Vertex.Vertex3<V1,V2,V>>build() {
        ...
        public final TypedVertexLayoutBuilder4<E1, V1, E2, V2, E, V>.InitialStage then() {
            final TypedVertexLayoutBuilder4<E1, V1, E2, V2, E, V> builder = new TypedVertexLayoutBuilder4<>(newLast());
