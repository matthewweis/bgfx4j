...
public class TypedVertexLayoutBuilder3<E1 extends BgfxAttrib, N1 extends Num, T1 extends BgfxAttribType, V1 extends Vec<N1, T1>, E2 extends BgfxAttrib, N2 extends Num, T2 extends BgfxAttribType, V2 extends Vec<N2, T2>> {
    private final VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, N2, T2, V2> last;

    TypedVertexLayoutBuilder3(VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, N2, T2, V2> last) {
        this.last = last;
    }
    ...
    public class AttribTypeStageDefaultOpts<E extends BgfxAttrib, N extends Num, T extends BgfxAttribType, V extends Vec<N, T>> {
        ...
        final VertexLayoutStructBuilder3<E1, N1, T1, V1, E2, N2, T2, V2, E, N, T, V> newLast() {
            return new VertexLayoutStructBuilder3<>(last, attrib, num, type, normalized, asInt);
        }

        public final VertexLayoutStruct3<E1, N1, T1, V1, E2, N2, T2, V2, E, N, T, V> build() {
            return build(Capabilities.getRendererType());
        }

        public final VertexLayoutStruct3<E1, N1, T1, V1, E2, N2, T2, V2, E, N, T, V> build(
                @NotNull BGFX_RENDERER_TYPE rendererType) {
            final VertexLayoutStructBuilder<?, ?, ?, ?>[] builders = VertexLayoutStructBuilder.createBuildersArray(3, newLast());
        ...
        public final TypedVertexLayoutBuilder4<E1, N1, T1, V1, E2, N2, T2, V2, E, N, T, V>.InitialStage then(
        ) {
            final TypedVertexLayoutBuilder4<E1, N1, T1, V1, E2, N2, T2, V2, E, N, T, V> builder = new TypedVertexLayoutBuilder4<>(newLast());
