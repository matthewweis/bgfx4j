...
public class VertexLayoutStruct15<V1 extends Vec<?,?>,
        ...
        V14 extends Vec<?,?>, V15 extends Vec<?,?>> extends VertexLayoutStruct {
    protected VertexLayoutStruct15(BGFXVertexLayout layout) {
        super(layout);
    }

    @NotNull
    public final TypedDynamicVertexBuffer15<V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12,V13,V14,V15> mallocDynamicBuffer(
