...
public class VertexLayoutStruct15<E1 extends BgfxAttrib, N1 extends Num, T1 extends BgfxAttribType, V1 extends Vec<N1, T1>,
        ...
        E14 extends BgfxAttrib, N14 extends Num, T14 extends BgfxAttribType, V14 extends Vec<N14, T14>, E15 extends BgfxAttrib, N15 extends Num, T15 extends BgfxAttribType, V15 extends Vec<N15, T15>> extends VertexLayoutStruct {
    protected VertexLayoutStruct15(BGFXVertexLayout layout) {
        super(layout);
    }

    @NotNull
    public final TypedDynamicVertexBuffer15<T1,N1,V1,T2,N2,V2,T3,N3,V3,T4,N4,V4,T5,N5,V5,T6,N6,V6,T7,N7,V7,T8,N8,V8,T9,N9,V9,T10,N10,V10,T11,N11,V11,T12,N12,V12,T13,N13,V13,T14,N14,V14,T15,N15,V15> mallocDynamicBuffer(
