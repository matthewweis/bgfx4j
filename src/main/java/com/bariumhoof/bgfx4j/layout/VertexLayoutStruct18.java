...
public class VertexLayoutStruct18<E1 extends BgfxAttrib, N1 extends Num, T1 extends BgfxAttribType, V1 extends Vec<N1, T1>,
        ...
        E18 extends BgfxAttrib, N18 extends Num, T18 extends BgfxAttribType, V18 extends Vec<N18, T18>> extends VertexLayoutStruct {
    protected VertexLayoutStruct18(BGFXVertexLayout layout) {
        super(layout);
    }

    @NotNull
    public final TypedDynamicVertexBuffer18<T1,N1,V1,T2,N2,V2,T3,N3,V3,T4,N4,V4,T5,N5,V5,T6,N6,V6,T7,N7,V7,T8,N8,V8,T9,N9,V9,T10,N10,V10,T11,N11,V11,T12,N12,V12,T13,N13,V13,T14,N14,V14,T15,N15,V15,T16,N16,V16,T17,N17,V17,T18,N18,V18> mallocDynamicBuffer(
