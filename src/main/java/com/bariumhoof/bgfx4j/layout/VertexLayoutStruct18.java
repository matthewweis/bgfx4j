...
public class VertexLayoutStruct18<V1 extends Vec<?,?>,
        ...
        V16 extends Vec<?,?>, V17 extends Vec<?,?>,
        V18 extends Vec<?,?>> extends VertexLayoutStruct {
    protected VertexLayoutStruct18(BGFXVertexLayout layout) {
        super(layout);
    }

    @NotNull
    public final TypedDynamicVertexBuffer18<V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12,V13,V14,V15,V16,V17,V18> mallocDynamicBuffer(
