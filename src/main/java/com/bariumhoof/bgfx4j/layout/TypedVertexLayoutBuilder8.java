...
public class TypedVertexLayoutBuilder8<E1 extends BgfxAttrib, V1 extends Vec<?,?>, E2 extends BgfxAttrib, V2 extends Vec<?,?>, E3 extends BgfxAttrib, V3 extends Vec<?,?>, E4 extends BgfxAttrib, V4 extends Vec<?,?>, E5 extends BgfxAttrib, V5 extends Vec<?,?>, E6 extends BgfxAttrib, V6 extends Vec<?,?>, E7 extends BgfxAttrib, V7 extends Vec<?,?>> {
    private final VertexLayoutStructBuilder7<E1, V1, E2, V2, E3, V3, E4, V4, E5, V5, E6, V6, E7, V7> last;

    TypedVertexLayoutBuilder8(
            VertexLayoutStructBuilder7<E1, V1, E2, V2, E3, V3, E4, V4, E5, V5, E6, V6, E7, V7> last) {
        this.last = last;
    }
    ...
    public class AttribTypeStageDefaultOpts<E extends BgfxAttrib, V extends Vec<?,?>> {
        ...
        final VertexLayoutStructBuilder8<E1, V1, E2, V2, E3, V3, E4, V4, E5, V5, E6, V6, E7, V7, E, V> newLast() {
            return new VertexLayoutStructBuilder8<>(last, attrib, vec, normalized, asInt);
        }

        public final VertexLayoutStruct8<V1,V2,V3,V4,V5,V6,V7,V> build() {
        ...
        public final TypedVertexLayoutBuilder9<E1, V1, E2, V2, E3, V3, E4, V4, E5, V5, E6, V6, E7, V7, E, V>.InitialStage then() {
            final TypedVertexLayoutBuilder9<E1, V1, E2, V2, E3, V3, E4, V4, E5, V5, E6, V6, E7, V7, E, V> builder = new TypedVertexLayoutBuilder9<>(newLast());
