...
public class VertexLayoutStruct4<V1 extends Vec<?,?>,
        V2 extends Vec<?,?>, V3 extends Vec<?,?>,
        V4 extends Vec<?,?>> extends VertexLayoutStruct {
    protected VertexLayoutStruct4(BGFXVertexLayout layout) {
        super(layout);
    }

    @NotNull
    public final TypedDynamicVertexBuffer4<V1,V2,V3,V4> mallocDynamicBuffer(
