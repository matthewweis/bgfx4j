...
public class TypedVertexLayoutBuilder4<E1 extends BgfxAttrib, N1 extends Num, T1 extends BgfxAttribType, V1 extends Vec<N1, T1>, E2 extends BgfxAttrib, N2 extends Num, T2 extends BgfxAttribType, V2 extends Vec<N2, T2>, E3 extends BgfxAttrib, N3 extends Num, T3 extends BgfxAttribType, V3 extends Vec<N3, T3>> {
    private final VertexLayoutStructBuilder3<E1, N1, T1, V1, E2, N2, T2, V2, E3, N3, T3, V3> last;

    TypedVertexLayoutBuilder4(
            VertexLayoutStructBuilder3<E1, N1, T1, V1, E2, N2, T2, V2, E3, N3, T3, V3> last) {
        this.last = last;
    }
    ...
    public class AttribTypeStageDefaultOpts<E extends BgfxAttrib, N extends Num, T extends BgfxAttribType, V extends Vec<N, T>> {
        ...
        final VertexLayoutStructBuilder4<E1, N1, T1, V1, E2, N2, T2, V2, E3, N3, T3, V3, E, N, T, V> newLast(
        ) {
            return new VertexLayoutStructBuilder4<>(last, attrib, num, type, normalized, asInt);
        }

        public final VertexLayoutStruct4<E1, N1, T1, V1, E2, N2, T2, V2, E3, N3, T3, V3, E, N, T, V> build(
        ) {
        ...
        public final TypedVertexLayoutBuilder5<E1, N1, T1, V1, E2, N2, T2, V2, E3, N3, T3, V3, E, N, T, V>.InitialStage then(
        ) {
            final TypedVertexLayoutBuilder5<E1, N1, T1, V1, E2, N2, T2, V2, E3, N3, T3, V3, E, N, T, V> builder = new TypedVertexLayoutBuilder5<>(newLast());
