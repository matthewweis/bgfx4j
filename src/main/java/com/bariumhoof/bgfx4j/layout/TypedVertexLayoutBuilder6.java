...
public class TypedVertexLayoutBuilder6<E1 extends BgfxAttrib, N1 extends Num, T1 extends BgfxAttribType, V1 extends Vec<N1, T1>, E2 extends BgfxAttrib, N2 extends Num, T2 extends BgfxAttribType, V2 extends Vec<N2, T2>, E3 extends BgfxAttrib, N3 extends Num, T3 extends BgfxAttribType, V3 extends Vec<N3, T3>, E4 extends BgfxAttrib, N4 extends Num, T4 extends BgfxAttribType, V4 extends Vec<N4, T4>, E5 extends BgfxAttrib, N5 extends Num, T5 extends BgfxAttribType, V5 extends Vec<N5, T5>> {
    ...
    public class AttribTypeStageDefaultOpts<E extends BgfxAttrib, N extends Num, T extends BgfxAttribType, V extends Vec<N, T>> {
        ...
        final VertexLayoutStructBuilder6<E1, N1, T1, V1, E2, N2, T2, V2, E3, N3, T3, V3, E4, N4, T4, V4, E5, N5, T5, V5, E, N, T, V> newLast(
        ) {
            return new VertexLayoutStructBuilder6<>(last, attrib, num, type, normalized, asInt);
        }

        public final VertexLayoutStruct6<E1, N1, T1, V1, E2, N2, T2, V2, E3, N3, T3, V3, E4, N4, T4, V4, E5, N5, T5, V5, E, N, T, V> build(
        ) {
        ...
        public final VertexLayoutStruct6<E1, N1, T1, V1, E2, N2, T2, V2, E3, N3, T3, V3, E4, N4, T4, V4, E5, N5, T5, V5, E, N, T, V> build(
            ...
            final VertexLayoutStructBuilder<?, ?, ?, ?>[] builders = VertexLayoutStructBuilder.createBuildersArray(6, newLast());
        ...
        public final TypedVertexLayoutBuilder7<E1, N1, T1, V1, E2, N2, T2, V2, E3, N3, T3, V3, E4, N4, T4, V4, E5, N5, T5, V5, E, N, T, V>.InitialStage then(
        ) {
            final TypedVertexLayoutBuilder7<E1, N1, T1, V1, E2, N2, T2, V2, E3, N3, T3, V3, E4, N4, T4, V4, E5, N5, T5, V5, E, N, T, V> builder = new TypedVertexLayoutBuilder7<>(newLast());
