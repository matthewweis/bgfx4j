...
public class TypedVertexLayoutBuilder15<V1 extends Vec<?,?>, V2 extends Vec<?,?>, V3 extends Vec<?,?>, V4 extends Vec<?,?>, V5 extends Vec<?,?>, V6 extends Vec<?,?>, V7 extends Vec<?,?>, V8 extends Vec<?,?>, V9 extends Vec<?,?>, V10 extends Vec<?,?>, V11 extends Vec<?,?>, V12 extends Vec<?,?>, V13 extends Vec<?,?>, V14 extends Vec<?,?>> {
    ...
    public class AttribTypeStageDefaultOpts<E extends BgfxAttrib, V extends Vec<?,?>> {
        ...
        public final VertexLayout<Vertex.Vertex15<V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12,V13,V14,V>> build() {
            return build(Capabilities.getRendererType());
        }

        public final VertexLayout<Vertex.Vertex15<V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12,V13,V14,V>> build(
                @NotNull BGFX_RENDERER_TYPE rendererType) {
            final VertexLayoutBuilder<?>[] builders = VertexLayoutBuilder.createBuildersArray(15, newLast());
