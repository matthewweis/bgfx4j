...
public class VertexLayoutStruct6<E1 extends BgfxAttrib, N1 extends Num, T1 extends BgfxAttribType, V1 extends Vec<N1, T1>,
        ...
        E6 extends BgfxAttrib, N6 extends Num, T6 extends BgfxAttribType, V6 extends Vec<N6, T6>> extends VertexLayoutStruct {
    protected VertexLayoutStruct6(BGFXVertexLayout layout) {
        super(layout);
    }

    @NotNull
    public final TypedDynamicVertexBuffer6<T1,N1,V1,T2,N2,V2,T3,N3,V3,T4,N4,V4,T5,N5,V5,T6,N6,V6> mallocDynamicBuffer(
            @NotNull VertexLayoutStruct6<E1,N1,T1,V1,E2,N2,T2,V2,E3,N3,T3,V3,E3,N4,T4,V4,E5,N5,T5,V5,E6,N6,T6,V6> vertexLayout,
