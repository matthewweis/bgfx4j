...
public class VertexLayoutStruct13<V1 extends Vec<?,?>,
        ...
        V12 extends Vec<?,?>, V13 extends Vec<?,?>> extends VertexLayoutStruct {
    protected VertexLayoutStruct13(BGFXVertexLayout layout) {
        super(layout);
    }

    @NotNull
    public final TypedDynamicVertexBuffer13<V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12,V13> mallocDynamicBuffer(
