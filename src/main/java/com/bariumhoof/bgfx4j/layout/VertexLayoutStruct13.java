...
public class VertexLayoutStruct13<E1 extends BgfxAttrib, N1 extends Num, T1 extends BgfxAttribType, V1 extends Vec<N1, T1>,
        ...
        E12 extends BgfxAttrib, N12 extends Num, T12 extends BgfxAttribType, V12 extends Vec<N12, T12>, E13 extends BgfxAttrib, N13 extends Num, T13 extends BgfxAttribType, V13 extends Vec<N13, T13>> extends VertexLayoutStruct {
    protected VertexLayoutStruct13(BGFXVertexLayout layout) {
        super(layout);
    }

    @NotNull
    public final TypedDynamicVertexBuffer13<T1,N1,V1,T2,N2,V2,T3,N3,V3,T4,N4,V4,T5,N5,V5,T6,N6,V6,T7,N7,V7,T8,N8,V8,T9,N9,V9,T10,N10,V10,T11,N11,V11,T12,N12,V12,T13,N13,V13> mallocDynamicBuffer(
