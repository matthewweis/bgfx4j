...
// todo move into vertexLayoutStruct inside a static builder() method
public interface TypedVertexLayout {

    static InitialStage builder() {
    ...
    public class AttribTypeStageDefaultOpts<E extends BgfxAttrib, N extends Num, T extends BgfxAttribType, V extends Vec<N,T>> {
        ...
        final VertexLayoutStructBuilder1<E, N, T, V> newLast() {
            return new VertexLayoutStructBuilder1<>(attrib, num, type, normalized, asInt);
        }

        public final VertexLayoutStruct1<E,N,T,V> build() {
            return build(Capabilities.getRendererType());
        }

        public final VertexLayoutStruct1<E,N,T,V> build(@NotNull BGFX_RENDERER_TYPE rendererType) {
        ...
        public final TypedVertexLayoutBuilder2<E,N,T,V>.InitialStage then() {
            final TypedVertexLayoutBuilder2<E, N, T, V> builder = new TypedVertexLayoutBuilder2<>(newLast());
