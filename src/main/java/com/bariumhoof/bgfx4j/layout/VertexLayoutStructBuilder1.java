...
public class VertexLayoutStructBuilder1<E1 extends BgfxAttrib, N1 extends Num, T1 extends BgfxAttribType, V1 extends Vec<N1, T1>> extends VertexLayoutStructBuilder<E1, N1, T1, V1> {

    protected VertexLayoutStructBuilder1(E1 attrib, N1 num, T1 type, boolean normalized, boolean asInt) {
        super(attrib, num, type, normalized, asInt);
    }

    // todo make all of these package private
...
//        final VertexLayoutStructBuilder<?, ?, ?, ?>[] builders = createBuildersArray(1, this);
//        final BGFXVertexLayout layout = createLayout(rendererType, builders);
//        return new VertexLayoutStruct1<>(layout);
//    }
//
//    // kinda confusing because InitialStage really means to make next builder...
//
//    public TypedVertexLayoutBuilder2<E1, N1, T1, V1> then() {
//        return new TypedVertexLayoutBuilder2<>(this);
//    }

//
//    public VertexLayoutStructBuilder1<E1,N1,T1,V1> self() {
//        return this;
//    }
//
...
//
//        @Override
//        public VertexLayoutStructBuilder2<E1,N1,T1,V1,E,N,T,V> build() {
//            return new VertexLayoutStructBuilder2<>(self(), attrib, num, type, false, asInt);
//        }
//    }
//
...
//        @Override
//        public VertexLayoutStructBuilder2<E1,N1,T1,V1,E,N,T,V> build() {
//            return new VertexLayoutStructBuilder2<>(self(), attrib, num, type, normalized, false);
//        }
//
//    }
//
...
//
//        public VertexLayoutStructBuilder2<E1,N1,T1,V1,E,N,T,V> build() {
//            return new VertexLayoutStructBuilder2<>(self(), attrib, num, type, false, false);
//        }
//
//    }
//
...
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, Num.ONE, BgfxAttribType.UINT8, Vec.UINT8_Vec1> thenUse(E2 attrib, Num.ONE num, BgfxAttribType.UINT8 type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, Num.TWO, BgfxAttribType.UINT8, Vec.UINT8_Vec2> thenUse(E2 attrib, Num.TWO num, BgfxAttribType.UINT8 type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, THREE, BgfxAttribType.UINT8, Vec.UINT8_Vec3> thenUse(E2 attrib, THREE num, BgfxAttribType.UINT8 type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, Num.FOUR, BgfxAttribType.UINT8, Vec.UINT8_Vec4> thenUse(E2 attrib, Num.FOUR num, BgfxAttribType.UINT8 type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, THREE, BgfxAttribType.UINT10, Vec.UINT10_Vec3> thenUse(E2 attrib, THREE num, BgfxAttribType.UINT10 type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, Num.FOUR, BgfxAttribType.UINT10, Vec.UINT10_Vec4> thenUse(E2 attrib, Num.FOUR num, BgfxAttribType.UINT10 type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, Num.ONE, BgfxAttribType.INT16, Vec.INT16_Vec1> thenUse(E2 attrib, Num.ONE num, BgfxAttribType.INT16 type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, Num.TWO, BgfxAttribType.INT16, Vec.INT16_Vec2> thenUse(E2 attrib, Num.TWO num, BgfxAttribType.INT16 type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, THREE, BgfxAttribType.INT16, Vec.INT16_Vec3> thenUse(E2 attrib, THREE num, BgfxAttribType.INT16 type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, Num.FOUR, BgfxAttribType.INT16, Vec.INT16_Vec4> thenUse(E2 attrib, Num.FOUR num, BgfxAttribType.INT16 type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, Num.ONE, BgfxAttribType.HALF, Vec.HALF_Vec1> thenUse(E2 attrib, Num.ONE num, BgfxAttribType.HALF type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, Num.TWO, BgfxAttribType.HALF, Vec.HALF_Vec2> thenUse(E2 attrib, Num.TWO num, BgfxAttribType.HALF type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, THREE, BgfxAttribType.HALF, Vec.HALF_Vec3> thenUse(E2 attrib, THREE num, BgfxAttribType.HALF type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, Num.FOUR, BgfxAttribType.HALF, Vec.HALF_Vec4> thenUse(E2 attrib, Num.FOUR num, BgfxAttribType.HALF type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, Num.ONE, FLOAT, Vec.FLOAT_Vec1> thenUse(E2 attrib, Num.ONE num, FLOAT type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, Num.TWO, FLOAT, Vec.FLOAT_Vec2> thenUse(E2 attrib, Num.TWO num, FLOAT type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, THREE, FLOAT, FLOAT_Vec3> thenUse(E2 attrib, THREE num, FLOAT type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }
//    public <E2 extends BgfxAttrib> VertexLayoutStructBuilder2<E1, N1, T1, V1, E2, Num.FOUR, FLOAT, Vec.FLOAT_Vec4> thenUse(E2 attrib, Num.FOUR num, FLOAT type, boolean normalized, boolean asInt) {
//        return new VertexLayoutStructBuilder2<>(this, attrib, num, type, normalized, asInt);
//    }

    @Override
    @Nullable
    VertexLayoutStructBuilder<?, ?, ?, ?> previousBuilder() { return null; }
}
