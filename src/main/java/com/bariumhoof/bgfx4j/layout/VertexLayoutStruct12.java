...
public class VertexLayoutStruct12<V1 extends Vec<?,?>,
        ...
        V12 extends Vec<?,?>> extends VertexLayoutStruct {
    protected VertexLayoutStruct12(BGFXVertexLayout layout) {
        super(layout);
    }

    @NotNull
    public final TypedDynamicVertexBuffer12<V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12> mallocDynamicBuffer(
