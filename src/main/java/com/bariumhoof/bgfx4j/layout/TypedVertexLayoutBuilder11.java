...
public class TypedVertexLayoutBuilder11<E1 extends BgfxAttrib, V1 extends Vec<?,?>, E2 extends BgfxAttrib, V2 extends Vec<?,?>, E3 extends BgfxAttrib, V3 extends Vec<?,?>, E4 extends BgfxAttrib, V4 extends Vec<?,?>, E5 extends BgfxAttrib, V5 extends Vec<?,?>, E6 extends BgfxAttrib, V6 extends Vec<?,?>, E7 extends BgfxAttrib, V7 extends Vec<?,?>, E8 extends BgfxAttrib, V8 extends Vec<?,?>, E9 extends BgfxAttrib, V9 extends Vec<?,?>, E10 extends BgfxAttrib, V10 extends Vec<?,?>> {
    ...
    TypedVertexLayoutBuilder11(
            VertexLayoutStructBuilder10<E1, V1, E2, V2, E3, V3, E4, V4, E5, V5, E6, V6, E7, V7, E8, V8, E9, V9, E10, V10> last) {
        this.last = last;
    }
    ...
    public class AttribTypeStageDefaultOpts<E extends BgfxAttrib, V extends Vec<?,?>> {
        ...
        final VertexLayoutStructBuilder11<E1, V1, E2, V2, E3, V3, E4, V4, E5, V5, E6, V6, E7, V7, E8, V8, E9, V9, E10, V10, E, V> newLast() {
            return new VertexLayoutStructBuilder11<>(last, attrib, vec, normalized, asInt);
        }

        public final VertexLayoutStruct<Vertex.Vertex11<V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V>>build() {
        ...
        public final TypedVertexLayoutBuilder12<E1, V1, E2, V2, E3, V3, E4, V4, E5, V5, E6, V6, E7, V7, E8, V8, E9, V9, E10, V10, E, V>.InitialStage then() {
            final TypedVertexLayoutBuilder12<E1, V1, E2, V2, E3, V3, E4, V4, E5, V5, E6, V6, E7, V7, E8, V8, E9, V9, E10, V10, E, V> builder = new TypedVertexLayoutBuilder12<>(newLast());
