...
public class TypedVertexLayoutBuilder11<V1 extends Vec<?,?>, V2 extends Vec<?,?>, V3 extends Vec<?,?>, V4 extends Vec<?,?>, V5 extends Vec<?,?>, V6 extends Vec<?,?>, V7 extends Vec<?,?>, V8 extends Vec<?,?>, V9 extends Vec<?,?>, V10 extends Vec<?,?>> {
    ...
    public class AttribTypeStageDefaultOpts<E extends BgfxAttrib, V extends Vec<?,?>> {
        ...
        public final TypedVertexLayoutBuilder12<V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V>.InitialStage then() {
            final TypedVertexLayoutBuilder12<V1, V2, V3, V4, V5, V6, V7, V8, V9, V10, V> builder = new TypedVertexLayoutBuilder12<>(newLast());
