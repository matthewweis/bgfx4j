...
public class VertexLayoutStruct14<V1 extends Vec<?,?>,
        ...
        V14 extends Vec<?,?>> extends VertexLayoutStruct {
    protected VertexLayoutStruct14(BGFXVertexLayout layout) {
        super(layout);
    }

    @NotNull
    public final TypedDynamicVertexBuffer14<V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12,V13,V14> mallocDynamicBuffer(
