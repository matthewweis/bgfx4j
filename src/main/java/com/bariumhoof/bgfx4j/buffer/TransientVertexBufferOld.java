...
/*
 *  TransientVertexBufferOld and TransientIndexBufferOld have the following ways to create:
 *
...
@Slf4j
public class TransientVertexBufferOld implements Disposable, Handle {
...
//    final VertexLayout vertexLayout;
    ...
    private TransientVertexBufferOld(@NotNull BGFXTransientVertexBuffer buf) {
//        this.vertexLayout = vertexLayout;
    ...
    @NotNull
    public static TransientVertexBufferOld heapCreate() {
        return createImpl(null);
    }

    @NotNull
    public static TransientVertexBufferOld create(@NotNull MemoryStack stack) {
        return createImpl(stack);
    }

    @NotNull
    public static TransientVertexBufferOld heapAlloc(int vertexCount, @NotNull VertexLayoutOld vertexLayoutOld) {
        return allocImpl(vertexLayoutOld, vertexCount, null);
    }

    @NotNull
    public static TransientVertexBufferOld alloc(@NotNull VertexLayoutOld vertexLayoutOld, int vertexCount, @NotNull MemoryStack stack) {
        return allocImpl(vertexLayoutOld, vertexCount, stack);
    }

    @NotNull
    private static TransientVertexBufferOld allocImpl(@NotNull VertexLayoutOld vertexLayoutOld, int vertexCount, @Nullable MemoryStack memoryStack) {
        final TransientVertexBufferOld tvb = createImpl(memoryStack);
...
//    @NotNull
//    public static TransientVertexBufferOld[] create(int creationCount) {
//        final BGFXTransientVertexBuffer.Buffer buffers = BGFXTransientVertexBuffer.calloc(creationCount);
//        final TransientVertexBufferOld[] result = new TransientVertexBufferOld[creationCount];
//        for (int i=0; i < creationCount; i++) {
//            result[i] = new TransientVertexBufferOld(buffers.get(i));
//        }
//        return result;
//    }
//
//    @NotNull
//    public static TransientVertexBufferOld[] create(@NotNull MemoryStack stack, int creationCount) {
...
//
//    @NotNull
//    public static TransientVertexBufferOld[] createAndAlloc(int vertexCount, @NotNull VertexLayout layout, int creationCount) {
//        final BGFXTransientVertexBuffer.Buffer buffers = BGFXTransientVertexBuffer.calloc(creationCount);
//        final TransientVertexBufferOld[] result = new TransientVertexBufferOld[creationCount];
//        for (int i=0; i < creationCount; i++) {
//            final BGFXTransientVertexBuffer tvb = buffers.get(i);
//            bgfx_alloc_transient_vertex_buffer(tvb, vertexCount, layout.get());
//            result[i] = new TransientVertexBufferOld(tvb);
//        }
//        return result;
//    }
//
//    @NotNull
//    public static TransientVertexBufferOld[] createAndAlloc(@NotNull MemoryStack stack, int vertexCount, @NotNull VertexLayout layout, int creationCount) {
//        final BGFXTransientVertexBuffer.Buffer buffers = BGFXTransientVertexBuffer.callocStack(creationCount, stack);
//        final TransientVertexBufferOld[] result = new TransientVertexBufferOld[creationCount];
//        for (int i=0; i < creationCount; i++) {
//            final BGFXTransientVertexBuffer tvb = buffers.get(i);
...
//    }
    ...
    private static TransientVertexBufferOld createImpl(@Nullable MemoryStack stack) {
        ...
        return new TransientVertexBufferOld(tvb);
    }

    // todo expose in advanced api
    @NotNull
    static TransientVertexBufferOld wrap(@NotNull BGFXTransientVertexBuffer value) {
        return new TransientVertexBufferOld(value);
    }
...
//    @Deprecated
//    @NotNull
//    public static TransientVertexBufferOld heapCreate(@NotNull Number[][] vertices) {
...
//
//        return new TransientVertexBufferOld(buf);
//    }
...
//    }
    ...
    /**
     * Frees the data backing this {@link TransientVertexBufferOld}. This is only required for
     * {@link TransientVertexBufferOld}s that are created on heap. Those created on stack (by passing {@link MemoryStack})
