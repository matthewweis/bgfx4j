...
//    };
    ...
    public void init() {
        ...
        program = Program.loadOrNull(
                CubesMultipleVertexStream.class.getResource("/shaders/metal/cubes.vert"), // vertex shader
                CubesMultipleVertexStream.class.getResource("/shaders/metal/cubes.frag")  // fragment shader
        );
