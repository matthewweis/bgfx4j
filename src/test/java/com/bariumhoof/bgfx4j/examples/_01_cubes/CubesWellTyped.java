...
//import com.bariumhoof.bgfx4j.layout.*;
...
//import static com.bariumhoof.bgfx4j.layout.Vec.vec;
...
//
//    @SuppressWarnings("unchecked") // <-- the irony is not lost on me (todo use collections instead?)
//    final Vertex.Vertex2<FLOAT_Vec3, UINT8_Vec4>[] cubeVerts = new Vertex.Vertex2 []{
//            vertex(vec(-1.0f, 1.0f, 1.0f), pack(0xff000000)),
//            vertex(vec(1.0f, 1.0f, 1.0f), pack(0xff0000ff)),
//            vertex(vec(-1.0f, -1.0f, 1.0f), pack(0xff00ff00)),
//            vertex(vec(1.0f, -1.0f, 1.0f), pack(0xff00ffff)),
//            vertex(vec(-1.0f, 1.0f, -1.0f), pack(0xffff0000)),
//            vertex(vec(1.0f, 1.0f, -1.0f), pack(0xffff00ff)),
//            vertex(vec(-1.0f, -1.0f, -1.0f), pack(0xffffff00)),
//            vertex(vec(1.0f, -1.0f, -1.0f), pack(0xffffffff))};
//
...
//    };
//
//    private TypedDynamicVertexBuffer2<
...
//    public void init() {
//
//        final var layout = TypedVertexLayout
//                .beginWith(BgfxAttrib.POSITION, Num.THREE, BgfxAttribType.FLOAT, false, false)
//                .thenUse(BgfxAttrib.COLOR0, Num.FOUR, BgfxAttribType.UINT8, true, false)
//                .build();
//
//        vertices = TypedDynamicVertexBuffer.create(layout, cubeVerts.length, EnumSet.noneOf(BGFX_BUFFER.class));
...
//    }
//
//    static UINT8_Vec4 pack(int value) {
//        return vec(b(value >>> 24), b(value >>> 16), b(value >>> 8), b(value));
//    }
//
//    static byte b(int n) {
//        return (byte)n;
