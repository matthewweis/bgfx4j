 ...
 * https://raw.githubusercontent.com/bkaradzic/bgfx/master/examples/00-helloworld/logo.h
 */
//@UtilityClass
public class Logo {

    public static ByteBuffer create() {
        ByteBuffer logo = BufferUtils.createByteBuffer(s_logo.length);
    ...
    private static final int[] s_logo = new int[]{
